...
export class TopbarComponent implements OnInit, AfterViewInit {
  ...
  extrasNotificationsLayout: 'offcanvas' | 'dropdown' = 'offcanvas';
  extrasQuickActionsDisplay: boolean = false;
  extrasQuickActionsLayout: 'offcanvas' | 'dropdown' = 'offcanvas';
  extrasCartDisplay: boolean = false;
  extrasCartLayout: 'offcanvas' | 'dropdown' = 'offcanvas';
  extrasQuickPanelDisplay: boolean = false;
  extrasLanguagesDisplay: boolean = false;
  extrasUserDisplay: boolean = false;
  extrasUserLayout: 'offcanvas' | 'dropdown' = 'offcanvas';
  ...
  switchOrganization(ID) {
    this._topbar.SwitchOrganization(ID.value);
  }
}
